...
type WorkOrder struct {
	...
	VmInstanceUuid   string    `gorm:"type:varchar(64);charset:utf8;comment:'关联问题 云主机uuid';column:vmInstanceUuid" json:"vmInstanceUuid"`
...
const (
	// 工单状态
	WORK_ORDER_STATUS_WAIT   = 0 // 待接单
	WORK_ORDER_STATUS_ING    = 1 // 处理中
